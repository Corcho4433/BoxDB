...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Realizar_orden_venta`(in PIDcliente int, PIDempleado int, PIDtipoentrega int, observacion varchar(45))
BEGIN
	...
	#tengo que mandar el subtotal el total y el descuento
    ...
    VALUES (pidcliente, pidempleado, piddireccion, pidtipoentrega, subtotal, descuento, total, pfecha, pfechaentrega, observacion);
...
-- Dump completed on 2024-10-24 21:39:37
